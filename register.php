    ...
    <header id="register_login">  
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-6 col-md-12 my-auto mx-auto zaVeceEkrane">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h1 class="text-center mb-4 text-uppercase profilna">Join our team</h1>
                            <p class="text-center mb-3 mb-md-5">Already have an account? <a href="login.php">Login</a></p>
                            <form action="php_require/registerCheck.php" method="POST" onSubmit="return proveraRegistracija();" id="kontaktForma">
